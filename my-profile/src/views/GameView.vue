      ...
      games: [
        {
          ...
          info: '这是一个比较传统的细胞战争游戏，玩家可以控制细胞来攻击其它细胞，并占领所有细胞。创新点是增加了技能系统，可以对一些细胞使用技能，使其产生不同buff。并且增加了多人联机功能。',
          video: '',
        ...
        },
        {
          ...
          info: '本游戏的美学情感来源于大家小时候在纸上自制的新棋。也就是围追堵截棋。所有棋子必须下在自己一个棋子的旁边，棋子会形成根和叶的关系，一旦根节点死亡，所有叶子节点死亡。棋子会消耗资源，需要让自己的棋子分化出资源节点。整体感受有点类似于围棋。占领的区域越大，就有更多的资源。只不过围棋是最后结算，而这个是每回合都会结算当前领地的资产。',
          video: '',
...
使用RPGMakerMV制作。`,
        ...
        },
        {
          ...
          info: '这是一个基于卡牌的meta游戏，故事背景来自于经典疑案“迪亚特洛夫事件”以及经典克苏鲁神话《死亡山脉》。玩家将扮演一支搜索队，来到神秘的山脉搜索失踪的迪亚特洛夫小队队员。游戏前期会以纯2D视角来进行卡牌游戏，随着卡牌游戏的进行，也会不断发展剧情和出现新的卡组。在游戏后期，类似《邪恶铭刻》玩家会离开2D的画面，来到3D的世界探索和卡牌战斗，寻找伙伴死亡的原因。',
          video: '',
...
现代游戏中，画面越来越绚丽，但是也会带来过多的信息，使得玩家失去了“想象”的权利。我希望创造一个完全沉浸式的游戏，游戏中玩家将在一个只有文字的3D世界中遨游。从文字和音效中感受一个不同的世界。同时，本游戏还在尝试探索游戏作为游戏内容的表现形式。例如如何让文字表现恐惧？如何让文字表现空间感等。旨在探索一个全新媒介的可能性。`,
        ...
        },
        {
          ...
          info: `
一款实验性的metagame，之前的游戏都是带有强烈魔法圈的，在进入游戏后就会一直沉浸于该游戏。本游戏打破了以往的设计范式，让游戏运行时可以在多个窗口/网页/APP中互相交流，共同进行游戏。
...
因此在本游戏中，也会看到主角同时处于教室和卧室的情况。这并非是bug，而是涌现式结构导致的特性。`,
        ...
        },
        {
          ...
          info: `        
基于状态的推理，部分解决了传统点击解密的困局，玩家的每一次点击都在学习信息，而不是进入全新的状态。
