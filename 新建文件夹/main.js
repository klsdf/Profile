...
let games = [
    new GameInfo(
        "姆姆因子", 
        "姆姆因子是一款PVE的类RTS游戏， 本游戏的节奏很快，玩家开局后可以，玩家可以控制自己的细胞不断占领对方的细胞，感受基因混战的宏大场面。", 
...
$(document).ready(function () {
    ...
    //             游戏简介：<div class="game-info">${games[i].info}</div>
    //             游戏下载链接：<div class="game-download"><a target="_blank" href="${games[i].link}" >点击下载</a></div>
    //             游戏规则： <div class="content">${games[i].rulesInfo}</div>
    //         </div>
